+(function($){
	...
	*/
	 ...
	 * ====================================================
	*/
	$('.navbar .nav:first').after('<div class="screen-mini"><button data-type="screen-nav" class="btn btn-inverse screen-nav"><i class="fa fa-bars"></i></button><button data-type="screen-search" class="btn btn-inverse screen-search"><i class="fa fa-search"></i></button></div>')
	...
	$(document).on('click', function(e){
        ...
        switch( type ){
            ...
            break; case 'screen-search':
            	...
            	_ta.toggleClass('active')
            	$('.navbar .menu:first').toggleClass('roll-down')
	...
	*/
    ...
    //muti tab
    var apiArray = new Array($("div[id^='tabs']").length);
    $("div[id^='tabs']").each(function (index, secEle) {
            var secID = $(secEle).attr('id');
            $('#' + secID).switchable({
                triggers: $('#' + secID + ' .tab-menu a'),
                panels: '.tab-con .tcon'
            });
    });
